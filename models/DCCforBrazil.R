...
#acf(x = portfolio_returns^2, main = 'Portfolio Returns')
...
# Company 2 
auto.arima(log_returns_demean[,3])
# Exchange Rate 
auto.arima(log_returns_demean[,1])
